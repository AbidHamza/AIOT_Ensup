# Room 7 : Observabilité et MLOps léger
...
- Créer des dashboards de monitoring (Grafana)
- Collecter et visualiser des métriques
...
2. **Monitoring ML**
   - Métriques de modèle (accuracy, latency)
   - Détection de drift
   - Alertes
